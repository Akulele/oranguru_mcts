...
class OranguruEnginePlayer(RuleBotPlayer):
    ...
    FINISH_BLOW_CRITICAL_MAX_SCORE_DROP = float(os.getenv("ORANGURU_FINISH_BLOW_CRITICAL_MAX_SCORE_DROP", "0.35"))
    FINISH_BLOW_THREAT_MAX_SCORE_DROP = float(os.getenv("ORANGURU_FINISH_BLOW_THREAT_MAX_SCORE_DROP", "0.35"))
    ...
    SETUP_CAPTURE_GUARD_ENABLED = bool(int(os.getenv("ORANGURU_SETUP_CAPTURE_GUARD", "1")))
    SETUP_CAPTURE_MIN_POLICY_RATIO = float(os.getenv("ORANGURU_SETUP_CAPTURE_MIN_POLICY_RATIO", "0.0"))
    SETUP_CAPTURE_MAX_SCORE_DROP = float(os.getenv("ORANGURU_SETUP_CAPTURE_MAX_SCORE_DROP", "0.75"))
    SETUP_CAPTURE_SPEED_RATIO = float(os.getenv("ORANGURU_SETUP_CAPTURE_SPEED_RATIO", "0.95"))
    ...
    YAWN_FORCED_SWITCH_GUARD = bool(int(os.getenv("ORANGURU_YAWN_FORCED_SWITCH_GUARD", "1")))
    YAWN_SWITCH_REPLY_KO = float(os.getenv("ORANGURU_YAWN_SWITCH_REPLY_KO", "185.0"))
    YAWN_ALLOW_FINAL_KO = bool(int(os.getenv("ORANGURU_YAWN_ALLOW_FINAL_KO", "1")))
    NONBENEFICIAL_ATTACK_TERA_GUARD = bool(
        int(os.getenv("ORANGURU_NONBENEFICIAL_ATTACK_TERA_GUARD", "0"))
    )
    RAPID_SPIN_VALUE_GUARD = bool(int(os.getenv("ORANGURU_RAPID_SPIN_VALUE_GUARD", "0")))
    RAPID_SPIN_MAX_HAZARD_PRESSURE = float(os.getenv("ORANGURU_RAPID_SPIN_MAX_HAZARD_PRESSURE", "0.01"))
    RAPID_SPIN_MIN_REPLY_FACTOR = float(os.getenv("ORANGURU_RAPID_SPIN_MIN_REPLY_FACTOR", "95.0"))
    RAPID_SPIN_MIN_ALT_DAMAGE_GAIN = float(os.getenv("ORANGURU_RAPID_SPIN_MIN_ALT_DAMAGE_GAIN", "8.0"))
    PIVOT_CHURN_GUARD = bool(int(os.getenv("ORANGURU_PIVOT_CHURN_GUARD", "0")))
    PIVOT_CHURN_MIN_STREAK = int(os.getenv("ORANGURU_PIVOT_CHURN_MIN_STREAK", "2"))
    PIVOT_CHURN_MIN_ALT_DAMAGE_GAIN = float(os.getenv("ORANGURU_PIVOT_CHURN_MIN_ALT_DAMAGE_GAIN", "6.0"))
    ...
    SETUP_WINDOW_MAX_REPLY = float(os.getenv("ORANGURU_SETUP_WINDOW_MAX_REPLY", "120.0"))
    ...
    SETUP_WINDOW_HIGH_GAIN_MIN_POLICY_RATIO = float(os.getenv("ORANGURU_SETUP_WINDOW_HIGH_GAIN_MIN_POLICY_RATIO", "0.40"))
    ...
    RECOVERY_WINDOW_MAX_SCORE_DROP = float(os.getenv("ORANGURU_RECOVERY_WINDOW_MAX_SCORE_DROP", "0.28"))
    RECOVERY_WINDOW_HIGH_GAIN_MIN_POLICY_RATIO = float(os.getenv("ORANGURU_RECOVERY_WINDOW_HIGH_GAIN_MIN_POLICY_RATIO", "0.55"))
    ...
    LOW_HP_DEFENSIVE_TOP_GUARD = bool(int(os.getenv("ORANGURU_LOW_HP_DEFENSIVE_TOP_GUARD", "0")))
    ...
    SWITCH_GUARD_LOW_HP_TARGET_MIN_HP = float(os.getenv("ORANGURU_SWITCH_GUARD_LOW_HP_TARGET_MIN_HP", "0.35"))
    SWITCH_GUARD_LOW_HP_MIN_HP_GAIN = float(os.getenv("ORANGURU_SWITCH_GUARD_LOW_HP_MIN_HP_GAIN", "0.15"))
    SWITCH_GUARD_LOW_HP_POLICY_RATIO = float(os.getenv("ORANGURU_SWITCH_GUARD_LOW_HP_POLICY_RATIO", "0.45"))
    SWITCH_GUARD_LOW_HP_HEUR_FLOOR = float(os.getenv("ORANGURU_SWITCH_GUARD_LOW_HP_HEUR_FLOOR", "0.0"))
    SWITCH_GUARD_LEGACY_ATTACKS = bool(int(os.getenv("ORANGURU_SWITCH_GUARD_LEGACY_ATTACKS", "1")))
    ...
    FINISH_BLOW_CRITICAL_OPP_HP = float(os.getenv("ORANGURU_FINISH_BLOW_CRITICAL_OPP_HP", "0.10"))
    FINISH_BLOW_THREAT_OPP_HP = float(os.getenv("ORANGURU_FINISH_BLOW_THREAT_OPP_HP", "0.35"))
    FINISH_BLOW_THREAT_BOOSTS = float(os.getenv("ORANGURU_FINISH_BLOW_THREAT_BOOSTS", "2.0"))
    FINISH_BLOW_CRITICAL_MIN_POLICY_RATIO = float(
        os.getenv("ORANGURU_FINISH_BLOW_CRITICAL_MIN_POLICY_RATIO", "0.05")
    )
