...
class OranguruEnginePlayer(RuleBotPlayer):
    ...
    SETUP_FATAL_REPLY_MIN_REPLY = float(os.getenv("ORANGURU_SETUP_FATAL_REPLY_MIN_REPLY", "120.0"))
    SETUP_FATAL_REPLY_MAX_HP = float(os.getenv("ORANGURU_SETUP_FATAL_REPLY_MAX_HP", "0.90"))
