...
class OranguruEnginePlayer(RuleBotPlayer):
    ...
    LOW_HP_DEFENSIVE_TOP_CRITICAL_HP = float(os.getenv("ORANGURU_LOW_HP_DEFENSIVE_TOP_CRITICAL_HP", "0.12"))
    ...
    LOW_HP_CONTROL_TOP_GUARD = bool(int(os.getenv("ORANGURU_LOW_HP_CONTROL_TOP_GUARD", "1")))
    LOW_HP_CONTROL_TOP_MAX_HP = float(os.getenv("ORANGURU_LOW_HP_CONTROL_TOP_MAX_HP", "0.12"))
    LOW_HP_CONTROL_TOP_MIN_MARGIN = float(os.getenv("ORANGURU_LOW_HP_CONTROL_TOP_MIN_MARGIN", "0.05"))
    LOW_HP_CONTROL_TOP_MIN_RATIO = float(os.getenv("ORANGURU_LOW_HP_CONTROL_TOP_MIN_RATIO", "1.20"))
