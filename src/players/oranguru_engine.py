...
class OranguruEnginePlayer(RuleBotPlayer):
    ...
    FINISH_BLOW_NEAR_KO_RATIO = float(os.getenv("ORANGURU_FINISH_BLOW_NEAR_KO_RATIO", "0.90"))
    ...
    RECOVERY_WINDOW_HIGH_GAIN_MIN_POLICY_RATIO = float(os.getenv("ORANGURU_RECOVERY_WINDOW_HIGH_GAIN_MIN_POLICY_RATIO", "0.42"))
    RECOVERY_WINDOW_CRITICAL_HP = float(os.getenv("ORANGURU_RECOVERY_WINDOW_CRITICAL_HP", "0.30"))
    RECOVERY_WINDOW_CRITICAL_MIN_POLICY_RATIO = float(os.getenv("ORANGURU_RECOVERY_WINDOW_CRITICAL_MIN_POLICY_RATIO", "0.30"))
