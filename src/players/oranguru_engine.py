...
class OranguruEnginePlayer(RuleBotPlayer):
    ...
    NONBENEFICIAL_ATTACK_TERA_GUARD = bool(
        int(os.getenv("ORANGURU_NONBENEFICIAL_ATTACK_TERA_GUARD", "1"))
    )
    RAPID_SPIN_VALUE_GUARD = bool(int(os.getenv("ORANGURU_RAPID_SPIN_VALUE_GUARD", "1")))
    ...
    PIVOT_CHURN_GUARD = bool(int(os.getenv("ORANGURU_PIVOT_CHURN_GUARD", "1")))
