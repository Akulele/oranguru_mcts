...
def init_mcts_stats() -> Dict[str, float]:
    return {
        ...
        "passive_breaker_calls": 0,
        "passive_breaker_lowconf_skip": 0,
        "passive_breaker_nonpassive_top": 0,
        "passive_breaker_no_priors": 0,
        "passive_breaker_no_candidate": 0,
        "passive_breaker_min_prob": 0,
        "passive_breaker_min_margin": 0,
        "tera_pruner_used": 0,
